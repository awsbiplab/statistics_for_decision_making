...
def main():
    print("=" * 65)
    print("  STATISTICS FOR DECISION MAKING ")
    print("  Author : Biplab Mitra  |  Batch: CPDA")
    print("=" * 65)
    ...
    print("\n[Q1022222] Bathroom Premium Hypothesis Test")
